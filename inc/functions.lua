--[[
   ...
   ─
│@UIX_XIU
تم تطوير السورس بواسطه مطور سورس البوب ✾
│@eljo_ker_m ‿ @UIX_XIU
#-------------------------------------------------------------------
]]
...
elseif UserID == 1027286620 then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك حظر مـالـك الـسـورس\n") 
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1027286620 then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك كتم مـالـك الـسـورس\n") 
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then 
...
elseif UserID == 1027286620 then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك طرد مـالـك الـسـورس\n") 
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then 
...
return sendMsg(ChatID,MsgID,"• **لا يمكنك تقييد المطور الاساسي\n") 
elseif UserID == 1027286620 then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك تقييد مـالـك الـسـورس\n") 
elseif redis:sismember(blank..':SUDO_BOT:',UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك تقييد المطور\n") 
elseif redis:sismember(blank..':MONSHA_BOT:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,"• **لا يمكنك تقييد المنشئ\n") 
